...
class MyOrdersViewController: MomViewController {
...
extension MyOrdersViewController : UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let orderStatusVC = storyboard?.instantiateViewController(withIdentifier: "orderStatusVC") as! OrderStatusViewController
